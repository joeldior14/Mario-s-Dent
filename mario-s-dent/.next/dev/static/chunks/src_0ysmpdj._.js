...
function PosPage() {
    ...
    // Estados para pago en efectivo y cálculo de vuelto
    ...
    // Consulta en Supabase del inventario de la sucursal asignada
                ...
                const formatted = rawProducts.map({
                    "PosPage.useCallback[loadBranchProducts].formatted": (p)=>{
                        ...
                        const branchMatch = invList.find({
                            "PosPage.useCallback[loadBranchProducts].formatted.branchMatch": (b)=>b.branches?.name?.toLowerCase() === currentBranch.toLowerCase()
    ...
    // Filtro reactivo por categoría y búsqueda
    ...
    // Agregar producto validando turno y límite de stock físico
    ...
    // Escaneo continuo con pistola lectora o Enter[cite: 1, 2]
    const handleScannerKeyDown = (e)=>{
        if (e.key === "Enter") {
            ...
            if (!code) return;
            const matched = products.find((p)=>p.sku.toLowerCase() === code || p.barcode && p.barcode.toLowerCase() === code || p.name.toLowerCase().includes(code));
            if (matched) {
    ...
    // Modificar cantidad individual (+ / -)[cite: 1]
    ...
    // Cálculos contables (IVA 13% El Salvador)[cite: 1, 2]
    ...
    // Cálculo dinámico del cambio / vuelto[cite: 1, 2]
    ...
    // Cobro y registro en Supabase[cite: 1, 2]
    const handleCheckout = async ()=>{
        ...
        try {
            ...
            // Recargar existencias en vivo tras la venta[cite: 1, 2]
            await loadBranchProducts();
        } catch (err) {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: `border-2 rounded-xl p-3 bg-white flex items-center gap-3 shadow-xs transition-colors ${!isShiftOpen ? "border-amber-300 bg-amber-50/20" : "border-sky-500"}`,
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$scan$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Scan$3e$__["Scan"], {
                                        className: `w-6 h-6 shrink-0 ${!isShiftOpen ? "text-amber-500" : "text-sky-600"}`
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/pos/page.tsx",
                                        lineNumber: 438,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                        ...
                                        placeholder: !isShiftOpen ? "Turno cerrado: dirígete a Caja para registrar fondo inicial y cobrar..." : "Escanear código de barras o escribir SKU / Producto...",
                                ...
                                children: cart.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Selecciona un producto del catálogo o escanea su código de barras[cite: 1]."
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/pos/page.tsx",
                                            lineNumber: 585,
                                            columnNumber: 17
                                    ...
                                    columnNumber: 15
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "flex items-center border border-slate-200 rounded-lg bg-white mr-3 shadow-2xs",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        type: "button",
                                                        onClick: ()=>handleUpdateQty(item.id, -1),
                                                        className: "p-1 hover:bg-slate-100 text-slate-500 transition-colors rounded-l-lg cursor-pointer",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "text-xs px-2 font-bold text-slate-700 tabular-nums",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        className: "p-1 hover:bg-slate-100 text-slate-500 transition-colors rounded-r-lg cursor-pointer disabled:opacity-40",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "text-xs font-bold text-slate-800 mr-2 min-w-[60px] text-right tabular-nums",
                                                children: [
                                                    "$",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        className: "px-2 py-0.5 bg-white border border-slate-200 hover:border-sky-400 text-slate-700 text-[10px] font-bold rounded-lg transition-colors cursor-pointer",
                                                        children: [
                                                            "Exacto ($",
                                                            total.toFixed(2),
                                                            ")"
                                                    ...
                                                    CASH_SUGGESTIONS.filter((val)=>val >= total).slice(0, 3).map((val)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                            type: "button",
...
_s(PosPage, "kdcx/WiOSW9UA7hHdtWCvFdFbCs=", false, function() {
    return [
...
//# sourceMappingURL=src_0ysmpdj._.js.map