...
"[project]/src/app/context/AuthContext.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {

var e = new Error("Could not parse module '[project]/src/app/context/AuthContext.tsx'\n\nExpected a semicolon");
...
function ShiftProvider({ children }) {
    ...
    const [cashierName, setCashierName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("Maria G.");
    ...
    const [initialCash, setInitialCash] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [openedAt, setOpenedAt] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [auditStatus, setAuditStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("pending_review");
    ...
    const refreshShiftStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ShiftProvider.useCallback[refreshShiftStatus]": async ()=>{
            setIsLoading(true);
            setError(null);
            try {
                await Promise.resolve();
    ...
    }["ShiftProvider.useCallback[refreshShiftStatus]"], []);
    // Apertura de turno
    const openShift = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ShiftProvider.useCallback[openShift]": async (amount, cashier, branchName = "Santa Ana")=>{
            setIsLoading(true);
            setError(null);
            try {
                // 🔌 Conexión preparada para backend:
    ...
    const closeShift = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ShiftProvider.useCallback[closeShift]": async (countedCash, cashierNote)=>{
            void countedCash;
            void cashierNote;
            setIsLoading(true);
            setError(null);
    ...
    const resolveAudit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ShiftProvider.useCallback[resolveAudit]": async (notes, resolution)=>{
...
_s(ShiftProvider, "dB0X/n/iUR7CYiPSEYdB4vnjHFg=");
_c = ShiftProvider;
function useShift() {
    _s1();
...
//# sourceMappingURL=_16tj7vy._.js.map