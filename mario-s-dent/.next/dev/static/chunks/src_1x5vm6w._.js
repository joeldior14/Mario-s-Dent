...
function InventoryPage() {
    ...
    const handleConfirmTransfer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InventoryPage.useCallback[handleConfirmTransfer]": (productId, sourceBranch, targetBranch, qty)=>{
            setItems({
                "InventoryPage.useCallback[handleConfirmTransfer]": (prev)=>prev.map({
                        "InventoryPage.useCallback[handleConfirmTransfer]": (item)=>{
                            if (item.id !== productId) return item;
                            const updatedBranches = item.branches.map({
                                "InventoryPage.useCallback[handleConfirmTransfer].updatedBranches": (b)=>{
                                    if (b.branchName === sourceBranch) {
                                        return {
                                            ...b,
                                            stock: Math.max(0, b.stock - qty)
                                        };
                                    }
                            ...
                            }["InventoryPage.useCallback[handleConfirmTransfer].updatedBranches"]);
                            return {
                                ...item,
    ...
    const handleConfirmAdjustment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "InventoryPage.useCallback[handleConfirmAdjustment]": (type, quantity)=>{
            if (!adjustingProduct) return;
            const targetBranch = selectedBranch === "ALL" ? "Santa Ana" : selectedBranch;
            const delta = type === "add" ? quantity : -quantity;
            setItems({
                "InventoryPage.useCallback[handleConfirmAdjustment]": (prev)=>prev.map({
                        "InventoryPage.useCallback[handleConfirmAdjustment]": (it)=>{
                            if (it.id !== adjustingProduct.id) return it;
                            const updatedBranches = it.branches.map({
                                "InventoryPage.useCallback[handleConfirmAdjustment].updatedBranches": (b)=>{
                                    if (b.branchName === targetBranch) {
                                        return {
                                            ...b,
                                            stock: Math.max(0, b.stock + delta)
                                        };
                                    }
                                    return b;
                                }
                            }["InventoryPage.useCallback[handleConfirmAdjustment].updatedBranches"]);
                            return {
                                ...it,
                                branches: updatedBranches
                            };
...
function UserManagementModal({ isOpen, onClose }) {
    ...
    // Estados del formulario tipados sin 'any'
    ...
    const handleSave = (e)=>{
        ...
        if (!cleanFullName || !cleanUsername) {
            setError("El nombre y nombre de usuario son obligatorios.");
            return;
        }
        const defaultEmail = `${cleanUsername}@mariosdent.com`;
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: BRANCH_OPTIONS.map((b)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: b,
                                                        children: b
                                                    }, b, false, {
                                                        fileName: "[project]/src/components/GestionUsuariosModal.tsx",
...
_s(UserManagementModal, "bEV4jgcvSO8m27489ZdglPvRyko=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useId"]
    ];
});
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: filteredHistory.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                        ...
                        children: [
                            "No hay movimientos registrados para este producto en ",
                            currentBranch,
                            "."
                        ]
                    }, void 0, true, {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$shield$2d$check$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ShieldCheck$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/shield-check.mjs [app-client] (ecmascript) <export default as ShieldCheck>");
(()=>{
    const e = new Error("Cannot find module '@/utils/HaciendaExportaciendaExport'");
            ...
            return products.map({
                "HaciendaReportModal.useMemo[processedItems]": (p)=>{
                    ...
                    return {
                        ...
                        name: p.name,
                        brand: p.brand,
                        presentation: p.presentation || p.description || "Unidad",
                        units,
                        cost: p.cost,
                        price: p.price
                    };
...
function TransferStockModal({ isOpen, onClose, products, onConfirmTransfer }) {
    ...
    const handleTransfer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransferStockModal.useCallback[handleTransfer]": ()=>{
...
_s(TransferStockModal, "XHo6z07Wfrb42qTMT2eZqqDQ/S0=");
...
//# sourceMappingURL=src_1x5vm6w._.js.map